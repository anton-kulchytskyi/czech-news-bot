...
## Що це
Telegram-бот, який двічі на день збирає новини з чеських сайтів і надсилає дайджест **українською мовою** через Claude AI. Має постійну кнопку «📰 Дайджест зараз» для виклику дайджесту будь-коли (бот слухає Telegram через long-polling, реагує лише на налаштований `TELEGRAM_CHAT_ID`).
